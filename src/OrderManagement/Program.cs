...
// JWT Key can be set via environment variable JWT_KEY for production
...
{
    throw new InvalidOperationException("JWT Key cannot be empty. Set JWT_KEY environment variable or Jwt:Key in configuration.");
}
